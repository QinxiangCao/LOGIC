...
Module NaiveRule.
  ...
  Proof. unfold provable, RealProvable, impp, orp. auto. Qed.
  ...
  Proof. unfold provable, RealProvable, impp, orp. tauto. Qed.

  Lemma falsep_elim : forall x : expr, provable (impp falsep x).
  Proof. unfold provable, RealProvable, impp, falsep. destruct 1. Qed.

  Lemma excluded_middle : forall x : expr, provable (orp x (negp x)).
  Proof. unfold provable, RealProvable, orp, negp, impp, falsep. intros; tauto. Qed.

  Lemma coq_prop_intros : (forall P : Prop, P -> provable (coq_prop P)) .
  Proof. unfold provable, RealProvable, coq_prop. intros; tauto. Qed.
  
  Lemma coq_prop_elim : (forall (P : Prop) (x : expr), (P -> provable x) -> provable (impp (coq_prop P) x)) .
  Proof. unfold provable, RealProvable, impp, coq_prop. intros; auto. Qed.
